...
class WeatherScreen extends StatefulWidget {
  ...
  WeatherScreen({super.key, this.initialLat, this.initialLon});
...
class _WeatherScreenState extends State<WeatherScreen>
  ...
  void _setupAnimations() {
    ...
    _slideAnim = Tween<Offset>(
            begin: Offset(0, 0.15), end: Offset.zero)
  ...
  void _showSnackbar(String msg, {required bool isError}) {
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      content: Text(msg),
      backgroundColor: isError ? Colors.red.shade700 : Color(0xFF1B9E77),
  ...
  Color _getBgGradientTop(BmkgWeatherEntry? entry) {
    if (entry == null) return Color(0xFF0A2E1A);
    if (entry.isRainy) return Color(0xFF0D1B3E);
    if (entry.weatherCode == 0) return Color(0xFF0C3B6E);
    if (entry.weatherCode <= 2) return Color(0xFF134A8E);
    return Color(0xFF1A2744);
  }

  Color _getBgGradientBottom(BmkgWeatherEntry? entry) {
    if (entry == null) return Color(0xFF0E5234);
    if (entry.isRainy) return Color(0xFF1B3A60);
    if (entry.weatherCode == 0) return Color(0xFF1565C0);
    if (entry.weatherCode <= 2) return Color(0xFF1976D2);
    return Color(0xFF263570);
  }

  Color _getAccentColor(BmkgWeatherEntry? entry) {
    if (entry == null) return Color(0xFF4CAF50);
    if (entry.isRainy) return Color(0xFF64B5F6);
    if (entry.weatherCode == 0) return Color(0xFFFFCA28);
      ...
      body: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [bgTop, bgBottom, Color(0xFF0A1628)],
            ...
            SafeArea(
              child: Column(
                children: [
                  _buildTopBar(),
                  if (_isLoading)
                    Expanded(child: Center(child: _WeatherLoadingIndicator()))
                  else if (_hasError)
        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                color: context.cardBg.withOpacity(0.04),
              ),
            ),
          ),
          Positioned(
  ...
  Widget _buildTopBar() {
    return Padding(
      ...
      child: Row(
        children: [
          _glassButton(
            child: Icon(Icons.arrow_back_ios_new, color: Colors.white, size: 17),
          ...
          if (_isLocating)
            ...
            _glassButton(
              child: Icon(Icons.my_location, color: Colors.white, size: 17),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: context.cardBg.withOpacity(0.15),
              ...
              child: Row(
                ...
                children: [
                  Icon(Icons.location_on, color: context.cardBg, size: 13),
                  SizedBox(width: 4),
                  ConstrainedBox(
                  ...
                  Icon(Icons.keyboard_arrow_down, color: context.cardBg, size: 15),
                ],
              ),
            ),
          ),
          SizedBox(width: 8),
          _glassButton(
            child: Icon(Icons.refresh, color: Colors.white, size: 17),
            onTap: _fetchWeather,
          ),
        ],
      ),
        ...
        children: [
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(20),
                  border: Border.all(color: context.cardBg.withOpacity(0.2)),
                ),
                child: Row(
                  children: [
          ...
          Container(
            ...
            child: Text(
              current.weatherDesc,
              style: GoogleFonts.inter(
                  color: context.cardBg, fontSize: 16, fontWeight: FontWeight.w700),
            ),
          ),
  ...
  Widget _metricCard({
    ...
    return Expanded(
      child: Container(
        ...
        decoration: BoxDecoration(
          color: context.cardBg.withOpacity(0.09),
          borderRadius: BorderRadius.circular(18),
          border: Border.all(color: context.cardBg.withOpacity(0.14)),
          boxShadow: [
            BoxShadow(
  ...
  Widget _buildHourlyForecast(Color accent) {
    ...
    if (hourlyEntries.isEmpty) return SizedBox();
              ...
              return AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  gradient: isNow
                      ...
                      : null,
                  color: isNow ? null : context.cardBg.withOpacity(0.09),
                  borderRadius: BorderRadius.circular(18),
                  border: Border.all(
                    color: isNow ? accent.withOpacity(0.6) : context.cardBg.withOpacity(0.12),
                    width: isNow ? 1.5 : 1,
                  ),
                ),
                child: Column(
                  ...
                  children: [
                    ...
                    Text(entry.weatherIcon, style: TextStyle(fontSize: 22)),
                    Text(
                      '${entry.temperature}°',
                      style: GoogleFonts.inter(
                          color: Colors.white,
  ...
  Widget _buildDailyForecast() {
    ...
    if (days.isEmpty) return SizedBox();
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Text(rep.weatherIcon, style: TextStyle(fontSize: 20)),
          SizedBox(width: 8),
          Expanded(
          ...
          children: [
            ...
            ...tips.asMap().entries.map((entry) {
              ...
              return Container(
                ...
                decoration: BoxDecoration(
                  color: context.cardBg.withOpacity(0.06),
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(color: context.cardBg.withOpacity(0.08)),
                ),
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(tip['icon']!, style: TextStyle(fontSize: 22)),
                    SizedBox(width: 12),
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _buildBmkgAttribution() {
    return Padding(
      ...
      child: Container(
        padding: EdgeInsets.all(12),
        decoration: BoxDecoration(
          color: context.cardBg.withOpacity(0.05),
          borderRadius: BorderRadius.circular(12),
          ...
          children: [
            ...
            ElevatedButton.icon(
              ...
              style: ElevatedButton.styleFrom(
                ...
                foregroundColor: Color(0xFF0A3D2F),
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Row(
                  children: [
                    Icon(Icons.location_city, color: Colors.white70, size: 20),
                    SizedBox(width: 10),
                    Text('Pilih Kota',
                        style: GoogleFonts.inter(
                            color: context.cardBg,
                      ...
                      leading: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: isSelected
                              ...
                              : context.cardBg.withOpacity(0.05),
                          border: Border.all(
                            color: isSelected
                                ? Color(0xFF4CAF50)
                                : Colors.white24,
  ...
  Widget _glassCard({required Widget child}) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: context.cardBg.withOpacity(0.08),
        borderRadius: BorderRadius.circular(22),
        border: Border.all(color: context.cardBg.withOpacity(0.13)),
        boxShadow: [
          BoxShadow(
